...
namespace P3tr0viCh.Utils.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to • Поставляется «КАК ЕСТЬ», то есть автор не даёт никаких гарантий работоспособности программы, а также не несёт никакой ответственности за любой прямой, косвенный или иной ущерб, понесённый в результате её использования. Вы используете это программное обеспечение на свой риск..
        /// </summary>
