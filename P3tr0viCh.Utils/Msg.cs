...
namespace P3tr0viCh.Utils
{
    public static class Msg
    {
        ...
        public static void Question(string format, object arg0)
        {
            Question(string.Format(format, arg0));
        }
        
        public static void Question(string format, object arg0, object arg1)
        {
            Question(string.Format(format, arg0, arg1));
        }
